<?php
/**
 * Daily heartbeat cron for Panth_OrderAttachments. Skips if Panth_Core is
...
namespace Panth\OrderAttachments\Cron;

use Magento\Framework\Module\Manager as ModuleManager;
use Panth\OrderAttachments\Service\InstallReporter;
