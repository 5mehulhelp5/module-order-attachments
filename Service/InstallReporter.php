<?php
/**
 * Standalone install + heartbeat reporter for Panth_OrderAttachments.
 *
...
namespace Panth\OrderAttachments\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_OrderAttachments';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-order-attachments';
